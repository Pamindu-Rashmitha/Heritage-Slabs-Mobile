...
const CatalogHeader = ({
    ...
    <View style={styles.header}>
        ...
        <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
            ...
            <TouchableOpacity style={styles.searchBtn} activeOpacity={0.8} onPress={onNavigateCart}>
                <View>
                    <MaterialCommunityIcons
                        name="cart-outline"
                        size={22}
                        color={cartCount > 0 ? THEME.gold : THEME.textPrimary}
                    />
                    {cartCount > 0 && (
                        <View style={styles.headerIconBadge}>
                            <Text style={styles.headerIconBadgeText}>{cartCount > 99 ? '99+' : cartCount}</Text>
                        </View>
                    )}
                </View>
            </TouchableOpacity>
            <TouchableOpacity style={styles.searchBtn} activeOpacity={0.8} onPress={onNavigateTickets}>
                <MaterialCommunityIcons name="message-outline" size={22} color={THEME.textPrimary} />
            </TouchableOpacity>
        </View>
    </View>
);
        ...
        return (
            <SafeAreaView style={styles.container} edges={['top']}>
                ...
                <CatalogHeader
                    ...
                    onNavigateTickets={() => navigation.navigate('MyTickets')}
                    cartCount={cartCount}
                />
...
const styles = StyleSheet.create({
    ...
    searchBtn: { backgroundColor: 'rgba(255,255,255,0.08)', borderRadius: 12, padding: 10, position: 'relative' },
    headerIconBadge: {
        position: 'absolute',
        top: -6,
        right: -8,
    ...
    headerIconBadgeText: { color: '#fff', fontSize: 9, fontWeight: '800', textAlign: 'center' },
